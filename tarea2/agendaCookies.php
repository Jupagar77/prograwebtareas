...
if ($data) {
    if ($data['tipo'] == "agregar") {
        ...
        if ($eventos) {
            ...
            setcookie('eventos', json_encode($eventos));
        } else {
            $evento = [
                "dia" => $data['dia'],
                "hora" => $data['hora'],
        ...
        if ($data['tipo'] == "borrar") {
            if ($_COOKIE['eventos']) {
                $eventos = json_decode($_COOKIE['eventos']);
...
<div class="container">
    <h2>Calendario de eventos ( <img src="../images/cookie.ico" style="width: 25px;"> ) </h2>
    <a style="margin-bottom: 20px" href="agendaSessions.php">Usar sesiones</a>
    <table class="tg" style="width: 100%">
        ...
        foreach ($eventos as $key => $evento) {
            echo '<tr>
                  ...
                  <td> ' . $evento->evento . '</td>
                  <td> 
                    <form action="agendaCookies.php" method="post">
        ...
        <tr>
            <td class="tg-yw4l" colspan="4">
                <form action="agendaCookies.php" class="row" method="post">
